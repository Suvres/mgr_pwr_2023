...
Jest to rozwiązanie chmurowe udostępnione przez firmę Microsoft.\ Zawiera wiele usług i narzędzi z zakresu zarządzania IT.\ W trakcie rejestracji na platformie nie jest pobierana opłata.\ Opłacie podlega jedynie wykorzystywanie konkretnych usług oraz zasobów platformy \textir{(ang: pay-per-use)}.
\\ \\
...
\begin{itemize}
    \item aplikacja jako usługa \trans{ang. Software-as-a-Service, SaaS},
    \item interfejs jako usługa \trans{ang. Infrastucture-as-a-Service, IaaS},
    \item platforma jako usługa \trans{ang. Platfrom-as-a-Service, PaaS}.
\end{itemize}
...
\refsource{Rysunek}{fig:ms-azure} pokazuje obecny podział usług na platformie Microsoft Azure.\ Można wyróżnić wiele obszarów m.in. z zakresu bezpieczeństwa, zarządzania danymi, usług deweloperskich, analizy danych czy platformy aplikacji.
