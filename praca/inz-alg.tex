...
W pracy inżynierskiej opracowano autorski algorytm klasyfikacji. Do badań wykorzystno dane uzyskane z Instytutu Cyberbezpieczeństwa, działającego przy Uniwersytecie Nowy Brunszwik.\ Zbiór danych został opisany w \refsource{sekcji}{sec:data}.
