...
GNB to implementacja klasyfikacji naiwnej Bayesa opartej o rozkład normalny Gaussa.\ Algorytm ten wykorzystuje \textbf{równanie}~\ref{math:gnb} oparte o \textbf{równanie}~\ref{math:bayes}.\ Równanie klasyfikatora opisuje prawdopodobieństwo wystąpienia zdarzenia na podstawie znajomości warunków zdarzenia~\cite{Joyce2003}.\ Twierdzenie zostało przedstawione na \refsource{równaniu}{math:bayes}.
